...
namespace p511_oop
{
    internal class Passport
    {
        ...
        public virtual void PrintPaassport()
        {
            Console.WriteLine($"Name: {_firstName} {_lastName}, Series & Number {_series} {_number}");
        }
    }
    class ForeignPassport : Passport
    {
        ...
        public override void PrintPaassport()
        {
            Console.WriteLine($"Name: {_firstName} {_lastName}, Series & Number {_series} {_number}, ForeignNumber: {_foreignNumber}" +
                $", Visa: {_visa}");
        }
    }
}